	   ...
	   <h2>Message Reply</h2>
		...
		<form action="" method="post" name="form1">
          <table bgcolor="#F9F9F9" width="100%" align="center" cellpadding="5" cellspacing="5" border="0">
            <tr>
              <td width="10%" nowrap="nowrap" valign="middle" align="right" class="tb2">To:</td>
           ...
           <tr>
            ...
            <td align="left" valign="top"><textarea cols="99" rows="8" name="answer" class="textbox2"><?php echo getPostParameter('answer'); ?></textarea></td>
          </tr>
          <tr>
	        ...
	        <td align="left" valign="bottom">
				...
				<input type="submit" name="reply" id="reply" class="submit" value="Send Reply" />
