...
\*******************************************************************/
	...
	if (isset($_POST["action"]) && $_POST["action"] == "edit")
	{
			...
			if (count($errors) == 0)
			{
				...
				{
					$current_image = mysqli_fetch_array(smart_mysql_query("SELECT image FROM cashbackengine_retailers WHERE retailer_id='$retailer_id' LIMIT 1"));
          ...
          <tr>
            ...
            <td width="70%" valign="top">
				...
				<?php
					...
					if (mysqli_num_rows($sql_retailer_cats) > 0)
					{
						while ($row_retailer_cats = mysqli_fetch_array($sql_retailer_cats))
						{
          ...
          <tr>
            ...
            <td valign="top">
				...
				<?php
					...
					while ($row_retailer_countries = mysqli_fetch_array($sql_retailer_countries))
					{
