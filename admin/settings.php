        ...
        <table width="100%" cellpadding="2" cellspacing="3"  border="0">
          ...
          <tr>
            ...
            <td align="left" valign="middle">
				<input type="text" name="data[website_currency]" id="website_currency" class="textbox" size="4" maxlength="10" value="<?php echo $settings['website_currency']; ?>" />
          ...
          <tr>
            ...
            <td nowrap="nowrap" valign="middle"><input type="text" name="data[referral_commission]" value="<?php echo $settings['referral_commission']; ?>" size="2" class="textbox" />%<span class="note">percentage which users earn from their referred friends</span></td>
          </tr>
          <tr>
