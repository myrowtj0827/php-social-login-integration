...
\*******************************************************************/
	...
	if ($user != "")
	{
	  try {
		...
		$username		= mysqli_real_escape_string($conn, $user_profile["email"]);
		$fname			= mysqli_real_escape_string($conn, $user_profile["first_name"]);
		$lname			= mysqli_real_escape_string($conn, $user_profile["last_name"]);
		$email			= mysqli_real_escape_string($conn, $user_profile["email"]);
		$gender			= mysqli_real_escape_string($conn, $user_profile["gender"]);
