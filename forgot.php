	...
	<div class="form_box" style="padding: 10px">
      <form action="" method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="email" required="required" value="<?php echo getPostParameter('email'); ?>" />
          </div>
          <div class="form-group">
            <label><?php echo CBE1_SIGNUP_SCODE; ?></label>
				<input type="text" id="captcha" class="form-control" name="captcha" required="required" value="">
