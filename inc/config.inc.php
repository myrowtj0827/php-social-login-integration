...
\*******************************************************************/
	...
	/// MySQL Settings ///
	define('DB_NAME', 'halamile_cashback');	// MySQL database name
	define('DB_USER', 'halamile_cashbac');			// MySQL database user
	define('DB_PASSWORD', 'Cashback786');		// MySQL database password
