...
\*******************************************************************/
	...
	if (isset($_POST['action']) && $_POST['action'] == "friend")
	{
		...
		if (count($errs) == 0)
		{
			...
			smart_mysql_query("INSERT INTO cashbackengine_invitations SET user_id='".(int)$userid."', recipients='".mysqli_real_escape_string($conn, $recipients)."', message='".mysqli_real_escape_string($conn, $umessage)."', sent_date=NOW()");
...
?>
	...
	<?php if (REFER_FRIEND_BONUS > 0) { ?>
	<a name="refs"></a>
	<table style="background: #F7F7F7" width="100%" align="center" bgcolor="#F7F7F7" border="0" cellspacing="0" cellpadding="10">
	<tr height="100">
		<td width="25%" align="center" valign="top"><br/><span class="count stats1"><?php echo GetRefClicksTotal($userid); ?></span><br/><br/><?php echo CBE1_INVITE_STATS1; ?></td>
		<td width="25%" align="center" valign="top"><br/><span class="count stats2"><a href="#referrals"><?php echo GetReferralsTotal($userid); ?></a></span><br/><br/><?php echo CBE1_INVITE_STATS2; ?></td>
		<td width="25%" align="center" valign="top"><br/><span class="count stats3"><?php echo GetReferralsPendingBonuses($userid); ?></span><br/><br/><?php echo CBE1_INVITE_STATS3; ?></td>
		<td width="25%" align="center" valign="top"><br/><span class="count stats4"><?php echo GetReferralsPaidBonuses($userid); ?></span><br/><br/><?php echo CBE1_INVITE_STATS4; ?></td>
	</tr>
	</table><br/>
	<?php } ?>
	...
	<?php if (isset($_GET['msg']) and $_GET['msg'] == 1) { ?>
		<div class="alert alert-success"><?php echo CBE1_INVITE_SENT; ?> <a class="submit" href="<?php echo SITE_URL; ?>invite.php#send"><?php echo CBE1_INVITE_SEND_MORE; ?> &raquo;</a></div>
	<?php }else{ ?>
		...
		<tr>
			<td align="left" valign="top">
                ...
                <tr>
					<td width="6%">&nbsp;</td>
					<td width="43%" align="left" valign="top"><?php echo CBE1_INVITE_FNAME; ?> <span class="req">* </span></td>
					<td width="2%">&nbsp;</td>
					<td width="43%" align="left" valign="top"><?php echo CBE1_INVITE_EMAIL; ?> <span class="req">* </span><br/>
				</tr>
				<?php for ($i=1; $i<=FRIENDS_INVITATIONS_LIMIT; $i++) { ?>
                <tr>
					<td align="center" valign="middle"><span style="color: #777"><?php echo $i; ?>.</span></td>
					<td align="left" valign="top"><input type="text" name="fname[<?php echo $i; ?>]" class="form-control" value="<?php echo $fname[$i]; ?>" size="25" /></td>
					<td align="center" valign="middle">&nbsp;</td>
					<td align="left" valign="top"><input type="text" name="femail[<?php echo $i; ?>]" class="form-control" value="<?php echo $femail[$i]; ?>" size="25" /></td>
				</tr>
				<?php } ?>
                <tr>
					<td>&nbsp;</td>
					<td colspan="3" align="left" valign="top">
						...
						<textarea name="umessage" id="umessage" class="form-control" cols="54" rows="10"><?php echo ($_POST['umessage']) ? getPostParameter('umessage') : @$umessage; ?></textarea>
					</td>
				</tr>
				</table>
			</td>
