...
?>
		...
		<tr class="lifetime_cashback">
			<td valign="middle" align="left">&nbsp; <b><?php echo CBE1_BALANCE_LCASHBACK; ?></b></td>
		...
		<?php /*if (GetBalanceUpdateDate($userid)) { ?>
			<p class="text-center"<?php echo CBE1_BALANCE_TEXT2; ?> <?php echo GetBalanceUpdateDate($userid); ?></p>
		<?php }*/ ?>
                ...
                <tr class="<?php if (($cc%2) == 0) echo "row_even"; else echo "row_odd"; ?>">
                  ...
                  <td valign="middle" align="center">
					<?php
							...
							{
								echo " <span class='cashbackengine_tooltip' title='".$row['reason']."'><img src='".SITE_URL."images/info.png' align='absmiddle' /></span>";
							}
					?>
				  </td>
                </tr>
