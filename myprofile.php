...
?>
		...
		<form action="" method="post">
		   ...
		   <div class="form-group">
            ...
            <div class="form-group">
              <label for="phone"><?php echo CBE1_LABEL_PHONE; ?></label>
			...
			<div class="checkbox">
				...
				<input type="submit" class="btn btn-success btn-lg" name="Update" id="Update" value="<?php echo CBE1_MYPROFILE_UPBUTTON; ?>" />
				<input type="button" class="btn btn-default btn-lg" name="cancel" value="<?php echo CBE1_CANCEL_BUTTON; ?>" onClick="javascript:document.location.href='myaccount.php'" />
        </form>
		<br/>
	...
	<div class="col-md-4 col-md-offset-1">
		...
		<br>
		<h3 class="text-center"><?php echo CBE1_MYPROFILE_PASSWORD; ?></h3>
		<br>
		...
		?>
		  ...
		  <div class="form-group">
		    ...
		    <input type="password" class="form-control" name="newpassword2" id="newpassword2" value="">
		      ...
		      <button type="submit" class="btn btn-success btn-lg"><?php echo CBE1_MYPROFILE_PWD_BUTTON; ?></button>
		  </form>
