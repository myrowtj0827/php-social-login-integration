...
?>
	...
	?>
		...
		<?php while ($row_reviews = mysqli_fetch_array($result_reviews)) { $cc++; ?>
		 <tr>
			<td valign="middle" align="left"><h3>&nbsp;<a href="<?php echo GetRetailerLink($row_reviews['retailer_id'], GetStoreName($row_reviews['retailer_id'])); ?>"><?php echo GetStoreName($row_reviews['retailer_id']); ?></a></h3></td>
			<td valign="middle" align="center"><img src="<?php echo SITE_URL; ?>images/icons/rating-<?php echo $row_reviews['rating']; ?>.png" /></td>
