...
?>
	...
	<?php if (isset($_GET['msg']) && $_GET['msg'] == 1) { ?>
		<div class="alert alert-success"><?php echo CBE1_REPORT_SENT; ?></div>
	<?php } ?>
	...
	<?php if ($total > 0) { $row = mysqli_fetch_array($result); ?>
		...
		<?php if (!(isset($_GET['msg']) && $_GET['msg'] == 1)) { ?>		
			...
			<form action="" method="post">
				<textarea name="report" cols="55" rows="5" class="form-control"><?php echo getPostParameter('report'); ?></textarea>
